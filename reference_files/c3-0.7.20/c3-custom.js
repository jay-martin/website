// Adjusted line 1023, Axis.prototype.dyForYAxisLabel = function dyForYAxisLabel()
...
(function (global, factory) {
  ...
  Axis.prototype.dyForYAxisLabel = function dyForYAxisLabel() {
      ...
      if ($$.config.axis_rotated) {
          ...
          return position.isInner
              ? '1.2em'
              : -10 - ($$.config.axis_y_inner ? 0 : this.getMaxTickWidth('y') + 10); // changed last 0 from 10 to 0
      }
  };
  ...
  ChartInternal.prototype.gridTextDy = function (d) {
      return d.y_position === 'above' ? -5 : d.y_position === 'below' ? 10 : -5;
  };
  ChartInternal.prototype.yGridTextY = function (d) {
      return d.y_position === 'above'
          ? -5
          : d.y_position === 'below'
              ? 10
              : -5;
  ...
  ChartInternal.prototype.updateGrid = function (duration) {
      var $$ = this, main = $$.main, config = $$.config, xgridLine, xgridLineEnter, ygridLine, ygridLineEnter, xv = $$.xv.bind($$), yv = $$.yv.bind($$), xGridTextX = $$.xGridTextX.bind($$), yGridTextX = $$.yGridTextX.bind($$), yGridTextY = $$.yGridTextY.bind($$);
      // hide if arc type
      ...
      ygridLineEnter
          ...
          //.attr('y', yv)
          .attr('y', config.axis_rotated ? yGridTextY : yGridTextY)
          .attr('dx', $$.gridTextDx)
          .attr('dy', $$.gridTextDy)
          .style('opacity', 0);
      // update
