...
function initialize_animation_currently_closed(){
	...
	setTimeout(function () {
		...
		chart.xgrids([]);
		/*fade out text*/
		document.getElementById('output_line1').style.color = '#f5f3f2';
	}, timer);
	...
	setTimeout(function () {
		...
		document.getElementById('output_line1').innerHTML = '';
	}, timer);
}
...
function end_animation(){
	...
	setTimeout(function () {
		...
		document.getElementById('output_line1').style.color = 'black';
