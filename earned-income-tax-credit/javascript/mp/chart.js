var mp_chart = c3.generate({
    ...
    grid: {
        ...
        y: {
            lines: [{value: 0}, {value: 2097, text: "Your married EITC"}, {value: 3231, text: "Combined individual EITC's"}, {value: 585, text: "Your Partner's EITC"} ]
        }
    },
});