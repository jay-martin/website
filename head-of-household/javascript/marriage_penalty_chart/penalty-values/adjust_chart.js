function marriage_penalties_values_adjust_chart(){
    ...
    // Run chart builder
    hoh_marriage_penalty_value_chart_builder(marriagePenaltyChart, 'x_values', 'values', 200000, p2_income, p1_filing_status, p2_filing_status);
}
...
function marriage_penalties_values_modify_income(){
    ...
    // Move xgrids
    marriagePenaltyChart.xgrids([{value: p1_income, text:'Your income'},]);

    // Move point 
    penalty = combined_tax - married_tax;
    marriagePenaltyChart.load({columns: [ ['x_values_point', p1_income] , ['values_point', penalty], ] });
