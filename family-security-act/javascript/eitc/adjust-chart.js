    ...
    if (filingStatus==="married"){
        if(numChildren ==="three") {
            ...
            columns: [
                ...
                ['FSA_EITC', 0, 2569,  3000,  3000,  3000,  0,],
                ['EITC',     0, 6935,  6935,  6935,  5515,  1092,  0,],
        ...
        if(numChildren ==="two") {
            ...
            columns: [
                ...
                ['FSA_EITC', 0, 2549,  3000,  3000,  3000,  0,],
                ['EITC',     0, 6164,  6164,  6164,  4744,  322,   0,],
        ...
        if(numChildren === "none") {
            ...
            columns: [
                ...
                ['FSA_EITC', 0, 915,  1911,  2000,  2000,  1627,  0,],
                ['EITC',     0, 560,  560,   506,   200,   0,],
        ...
        if(numChildren==="three"){
            ...
            columns: [
                ...
                ['FSA_EITC', 0, 2000,  2000,  2000,  2000,  0,],
                ['EITC',     0, 5400,  6935,  6935,  6330,  3382,  0,],
        ...
        if(numChildren ==="two"){
            ...
            columns: [
                ...
                ['FSA_EITC', 0, 2000,  2000,  2000,  2000,  0,],
                ['EITC',     0, 4800,  6164,  6164,  5559,  2611,  0,],
                ['dif',      0, -2800, -4164, -4164, -3559, -2611, 0,     0]
            ]
            });
        }
        if(numChildren==="one"){
            ...
            columns: [
                ...
                ['FSA_EITC', 0, 1830,  2000,  2000,  2000,  0,],
                ['EITC',     0, 3733,  3733,  3733,  3275,  1037,  0,],
        ...
        if(numChildren ==="none"){
            ...
            columns: [
                ...
                ['FSA_EITC', 0, 915,  1000, 1000, 1000,  74,    0,],
                ['EITC',     0, 560,  560,  560,  496,   0,],
