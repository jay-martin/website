...
function adjust_child_benefit_chart_fsa_1(filingStatus, numYoung, numOld){
    /*************************************************************** Joint ************************************************************** */
        ...
        if(numYoung ==="none" && numOld==="two"){
            setTimeout(function () {
                ...
                columns: [
                    ...
                    ['CTC',      0,    0,     1125,  2800,  2800,  4000,  4000,   0,],
        ...
        if(numYoung ==="one" && numOld==="two"){
            setTimeout(function () {
                ...
                columns: [
                    ...
                    ['CTC',      0,     0,      1125,  3510,  4660,  6000,  6000,   0,],
        ...
        if(numYoung ==="two" && numOld==="two"){
            setTimeout(function () {
                ...
                columns: [
                    ...
                    ['CTC',      0,     0,      1125,  3510,  6993,  7655,  8000,  8000,   0,],
        ...
        if(numYoung ==="none" && numOld==="two"){
            setTimeout(function () {
                ...
                columns: [
                    ...
                    ['FSA_CA',   6000, 6000,  6000,  6000,  6000,  6000,  6000,   2000,   0],
                    ['CTC',      0,    0,     1125,  2535,  2977,  4000,  4000,   0,],
        ...
        if(numYoung ==="one" && numOld==="two"){
            setTimeout(function () {
                ...
                columns: [
                    ...
                    ['CTC',      0,     0,     1125,  2535,  5310,  5665,  6000,  6000,   0,],
        ...
        if(numYoung ==="two" && numOld==="two"){
            setTimeout(function () {
                ...
                columns: [
                    ...
                    ['FSA_CA',   14400, 14400,  14400, 14400, 14400,  14400, 14400, 14400,  6400,   0],
                    ['CTC',      0,     0,      1125,  2535,  6197.5, 7759,  8000,  8000,   0,],
        ...
        if(numYoung ==="none" && numOld==="two"){
            setTimeout(function () {
                ...
                columns: [
                    ...
                    ['CTC',      0,    0,     1125,  1567.5, 3622,  3828,   4000,   4000,   0,],
        ...
        if(numYoung ==="one" && numOld==="two"){
            setTimeout(function () {
                ...
                columns: [
                    ...
                    ['FSA_CA',   10200, 10200, 10200, 10200,  10200,  10200,  10200,  4200,   0],
                    ['CTC',      0,     0,     1125,  1567.5, 4136,   6000,   6000,   0,],
        ...
        if(numYoung ==="two" && numOld==="two"){
            setTimeout(function () {
                ...
                columns: [
                    ...
                    ['CTC',      0,     0,     1125,  1567.5,  4136,   8000,   8000,   0,],
...
function adjust_child_benefit_chart_fsa_2(filingStatus, numYoung, numOld){
    /*************************************************************** Joint ************************************************************** */
    if (filingStatus==="married"){
        /* NO YOUNG CHILDREN, VARY OLD CHILDREN */
        if(numYoung==="none" && numOld==="none") {
